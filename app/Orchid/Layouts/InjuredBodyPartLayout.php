...
class InjuredBodyPartLayout extends Table
{
    /**
     * Data source.
     *
     ...
     * @var string
     */
    protected $target = 'injuredBodyParts';
                    ...
                    return DropDown::make()
                        ...
                        ->list([
                            ModalToggle::make(__('Редактировать'))
                                ->modal('asyncUpdate')
                                ->modalTitle(__('Обновить часть тела'))
                                ->icon('note')
                                ->method('asyncUpdate')
                                ->asyncParameters(['id' => $target->id, 'name' => $target->name, 'model' => 'injuredBodyPart']),
